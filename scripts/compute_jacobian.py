...
flags.DEFINE_string("filename", "jac_ps_.pkl", "Output filename")
flags.DEFINE_string("pgd_params", "results_fit_PGD_205_128.pkl", "PGD parameter files")
...
def compute_jacobian(Omega_c, sigma8, pgdparams):
    ...
    with tf.GradientTape() as tape:
        tape.watch(params)
        m, lensplanes, r_center, a_center = compute_kappa(params[0], params[1],pgdparams)
    ...
    jac = tape.jacobian(power_spectrum, params, experimental_use_pfor=False, parallel_iterations=1)
