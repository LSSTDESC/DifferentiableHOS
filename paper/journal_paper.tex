...
\author{Denise Lanzieri \inst{1}\fnmsep\thanks{ Contact: denise.lanzieri@cea.fr}
\and
Fran\c{c}ois Lanusse \inst{2}
\and
Chirag Modi \inst{3}
\and 
Benjamin Horowitz \inst{4, 5}
\and
Joachim Harnois-Déraps \inst{6}
\and
Jean-Luc Starck \inst{2}
\and
...
\date{Received xxxx; accepted xxx}
...
\keywords{methods: statistical -- cosmology: large-scale structure of Universe --gravitational lensing:weak}
...
\end{equation}\label{Fisher_matrix}
